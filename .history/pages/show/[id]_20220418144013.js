...
function Show({ result }) {
    ...
    const index = result.videos.results.findIndex(video => video.type === "Trailer");
...
export async function getServerSideProps(context) {
    ...
    const request = await fetch(`https://api.themoviedb.org/3/show/${id}?api_key=${process.env.API_KEY}&language=en-US&append_to_response=videos`).then(res => res.json())
